setwd("/Users/takatoosetsuo/specialclass.git/shibaura23/0614/presen")##
source('/Applications/KeTTeX.app/texlive/texmf-dist/scripts/ketcindy/ketlib/ketpiccurrent.r')##
Ketinit()##
Setwindow(c((-0.001),(4.001)),c((-0.001),(2.101)))####
options(digits=10);##
arccos=acos; arcsin=asin; arctan=atan##
Dt=readLines('presen0614.tex',encoding='UTF-8')##
...
writeLines(Out,'presen0614digest.tex',sep='\n')##
